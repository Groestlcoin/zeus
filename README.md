# Zeus GRS
A mobile Groestlcoin/Lightning app for lnd and c-lightning node operators ⚡️
...
[Lightning Network Daemon (lnd)](https://github.com/LightningNetwork/lnd)  or [c-lightning](https://github.com/Groestlcoin/lightning) using the [c-lightning-REST](https://github.com/Ride-The-Lightning/c-lightning-REST/) API.

You must provide Zeus GRS with your node's hostname, port number, and the macaroon you choose to use in **hex format**. If you need help converting your macaroon to hex format we wrote up a Node.js script that can use
...
[3Lbz4vdt15Fsa4wVD3Yk8uGf6ugKKY4zSc](https://blockstream.info/address/3Lbz4vdt15Fsa4wVD3Yk8uGf6ugKKY4zSc), PayNym [+holymorning7d1](http://my.paynym.is/+holymorning7d1) or via [tippin.me](https://tippin.me/@ZeusLN).
